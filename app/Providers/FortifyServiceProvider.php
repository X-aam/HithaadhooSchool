...
use App\Actions\Fortify\RedirectIfEmailOtpRequired;
...
class FortifyServiceProvider extends ServiceProvider
{
    ...
    private function configureActions(): void
    {
        ...
        // Default login pipeline with an email OTP challenge for users without an authenticator app.
        Fortify::authenticateThrough(fn (Request $request) => array_filter([
            ...
            RedirectIfEmailOtpRequired::class,
